...
import {addDeck} from '../../../../data/indexedDB.js';
...
function init() {
	...
	const storageExampleDeck = new Deck({id:4,imageUrl:'',name:'servkjqhferk fhwerkjvhwdkjh',cardIds:[]}); 
	const storageExampleDeck2 = new Deck({id:5,imageUrl:'',name:'n',cardIds:[]}); 

	const cardImgExample = new Card({id:1,name:'gyatt',imageURL:'../create-deck/assets/images/card-back-evil.jpg',type:'water',hp:5,evolution:'vaporeon idk man'});
	const cardImgExample2 = new Card({id:2,name:'gyatt',imageURL:'../create-deck/assets/images/card-back-evil.jpg',type:'water',hp:5,evolution:'vaporeon idk man'});
